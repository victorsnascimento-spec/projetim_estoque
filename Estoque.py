...
def adicao(): 
    ...
    i = 0
    while i < 1:
            i = int(input("Qual a quantidade de produtos serão adicionados? "))
    while i > 0:
        ...
        print("--------------------------- LOCAL ------------------------------")
        novoLoc = input("Qual local o produto estará?") #Adiciona o local que o produto estara
            ...
            if (len(estoque))== 0:
                ...
                for itens in estoque:
                    if itens[2] == a:
                        ...
                        escolha = input("Deseja mudar a quantidade do ítem (s/n)?")
                        if escolha == "s":
